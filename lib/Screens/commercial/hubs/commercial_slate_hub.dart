...
class CommercialSlateHubForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('Slate (roof section)', style: TextStyle(fontWeight: FontWeight.bold)),
