...
robocopy $privateRepo $publicRepo /MIR `
 /XD ".git" "build" ".dart_tool" ".gradle" ".idea" ".vscode" "lib\secrets" "android\app\keys" `
 /XF ".env" ".env.production" "google-services.json" "GoogleService-Info.plist" "firebase_options.dart" "stripe_keys.dart" "local.properties" "key.properties" ".firebaserc" "*.keystore" "*.jks"
